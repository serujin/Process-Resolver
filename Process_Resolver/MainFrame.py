...
class MainFrame(tk.Frame):
    def __init__(self, parent, number):
        ...
        self.add_button.grid(row=2, column=0, padx=4, pady=10)
        self.del_button.grid(row=2, column=1, padx=4, pady=10)
        self.ini_button.grid(row=2, column=2, padx=4, pady=10)
